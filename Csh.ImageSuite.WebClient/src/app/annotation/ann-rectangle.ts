    ...
    onMouseEvent(mouseEventType: MouseEventType, point: Point) {
        ...
        if (mouseEventType === MouseEventType.MouseDown) {
            ...
            if (this.annPointList.length === 0) {
                ...
                this.annPointList.forEach(annObj => annObj.onDrawEnded(this.onPointDragged, this.onChildSelected));
                this.annLineList.forEach(annObj => annObj.onDrawEnded(this.onLineDragged, this.onChildSelected));
