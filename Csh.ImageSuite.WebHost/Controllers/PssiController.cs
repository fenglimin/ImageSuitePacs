...
using Image = Csh.ImageSuite.Model.Dicom.Image;
...
namespace Csh.ImageSuite.WebHost.Controllers
{
    public class PssiController : Controller
    {
        ...
        {
            var study = _dbHelper.GetStudy(id, false);
        ...
        [System.Web.Mvc.HttpPost]
        public string TransferStudy(Study study)
        {
            ...
            try
            {
                //string[] ImageUidList = StringWrapper.ConvertStringToStringArray(strSOPInstanceUIDList);
                ...
                string[] ImageUidList = new string[5];
        ...
        [Serializable]
        public partial class ExportStudyModel
        {
            public ExportStudyModel()
            { }

            private ExportJobDownLoadImageType _exportJobDownLoadImageType = ExportJobDownLoadImageType.JPEG;
            public ExportJobDownLoadImageType ExportJobDownLoadImageType
            {
                get { return _exportJobDownLoadImageType; }
                set { _exportJobDownLoadImageType = value; }
            }
            ...
            private string _rptFolderPath = GetRPTCacheFolderPath();
            ...
            {
                get { return _rptFolderPath; }
                set { _rptFolderPath = value; }
            }

            private string _datetimeSpanFolder = "";
            public string DatetimeSpanFolder
            {
                get { return _datetimeSpanFolder; }
                set { _datetimeSpanFolder = value; }
            }

            private string _sourceDicomDIR7ZFile = "";
            public string SourceDicomDIR7ZFile
            {
                get { return _sourceDicomDIR7ZFile; }
                set { _sourceDicomDIR7ZFile = value; }
            }

            private string _targetDicomDIR7ZFile = "";
            public string TargetDicomDIR7ZFile
            {
                get { return _targetDicomDIR7ZFile; }
                set { _targetDicomDIR7ZFile = value; }
            }

            private string _targetBurnCDFilePath = "";
            public string TargetBurnCDFilePath
            {
                get { return _targetBurnCDFilePath; }
                set { _targetBurnCDFilePath = value; }
            }
            //private string _tempTargetDicomDIR7ZFile = "";
            //public string TempTargetDicomDIR7ZFile
            //{
            //    get { return _tempTargetDicomDIR7ZFile; }
            //    set { _tempTargetDicomDIR7ZFile = value; }
            //}
            ...
            private int _removeDicomTagMASK_ALL = 7;
            public int RemoveDicomTagMASK_ALL
            {
                get { return _removeDicomTagMASK_ALL; }
                set { _removeDicomTagMASK_ALL = value; }
            }

            private bool _bImageIncludeDicomViewer = false;
            public bool BImageIncludeDicomViewer
            {
                get { return _bImageIncludeDicomViewer; }
                set { _bImageIncludeDicomViewer = value; }
            }

            private bool _bImageBurningDicomViewCD = false;
            public bool BImageBurningDicomViewCD
            {
                get { return _bImageBurningDicomViewCD; }
                set { _bImageBurningDicomViewCD = value; }
            }

            private string[] _exportImageUidsList = new string[] { };
            public string[] ExportImageUidsList
            {
                get { return _exportImageUidsList; }
                set { _exportImageUidsList = value; }
            }

            private List<KeyValuePair<string, string>> _imagesList = new List<KeyValuePair<string, string>>();
            ...
            private List<string> _sourceFileNameList = new List<string>();
            public List<string> SourceFileNameList
            {
                get { return _sourceFileNameList; }
                set { _sourceFileNameList = value; }
            }

            //private List<string> _middleStoreFileNameList = new List<string>();
            //public List<string> MiddleStoreFileNameList
            //{
            //    get { return _middleStoreFileNameList; }
            //    set { _middleStoreFileNameList = value; }
            //}

            private List<string> _targetFileNameList = new List<string>();
            public List<string> TargetFileNameList
            {
                get { return _targetFileNameList; }
                set { _targetFileNameList = value; }
            }

            private Dictionary<string, string> _targetDicomFileNamePatientGuidPairs = new Dictionary<string, string>();

            public Dictionary<string, string> TargetDicomFileNamePatientGuidPairs
            {
                get { return _targetDicomFileNamePatientGuidPairs; }
                set { _targetDicomFileNamePatientGuidPairs = value; }
            }


            private List<string> _selfExtractRequiredFileList = new List<string>();
            public List<string> SelfExtractRequiredFileList
            {
                get { return _selfExtractRequiredFileList; }
                set { _selfExtractRequiredFileList = value; }
            }

            private List<string> _targetReportFilePathList = new List<string>();
            public List<string> TargetReportFilePathList
            {
                get { return _targetReportFilePathList; }
                set { _targetReportFilePathList = value; }
            }
