...
(function (StepEnum) {
    ...
    StepEnum[StepEnum["Step2"] = 2] = "Step2";
    StepEnum[StepEnum["Step3"] = 3] = "Step3";
    StepEnum[StepEnum["Step4"] = 4] = "Step4";
    StepEnum[StepEnum["Step5"] = 5] = "Step5";
})(StepEnum || (StepEnum = {}));
...
var AnnObject = /** @class */ (function () {
    ...
    AnnObject.imageToScreen = function (point, transform) {
        var x = point.x;
        var y = point.y;
        var imgPt = [x, y, 1];
        var screenPt = [0, 0, 1];
...
/***/ "./src/app/annotation/annotation.module.ts":
/*!*************************************************!*\
  !*** ./src/app/annotation/annotation.module.ts ***!
  \*************************************************/
/*! exports provided: AnnotationModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnnotationModule", function() { return AnnotationModule; });
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _annotation_annotation_module__WEBPACK_IMPORTED_MODULE_30__["AnnotationModule"],
...
var ImageViewerComponent = /** @class */ (function () {
    ...
    ImageViewerComponent.prototype.doManualWl = function () {
        ...
        this.dialogService.showDialog(_components_dialog_manual_wl_dialog_manual_wl_dialog_component__WEBPACK_IMPORTED_MODULE_11__["ManualWlDialogComponent"], windowLevelData).subscribe(function (val) {
...
var ViewerToolbarComponent = /** @class */ (function () {
    function ViewerToolbarComponent(imageSelectorService, viewContext, configurationService) {
        ...
        this.resetButtonMenu = { name: "Reset", tip: "Reset", operationData: { type: _services_view_context_service__WEBPACK_IMPORTED_MODULE_2__["OperationEnum"].Reset, data: null } };
...
var OperateToolbarComponent = /** @class */ (function () {
    function OperateToolbarComponent(worklistService) {
        this.worklistService = worklistService;
    ...
    OperateToolbarComponent.prototype.onDelete = function () {
    };
...
var DatabaseService = /** @class */ (function () {
    ...
    DatabaseService.prototype.getStudy = function (id) {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.log("fetched Study id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError("getStudy id=" + id)));
    };
...
var WorklistService = /** @class */ (function () {
    ...
    WorklistService.prototype.onShowSingleStudy = function (study) {
        ...
        if (this.isUsingLocalTestData()) {
            ...
            this.databaseService.getStudy(study.id).subscribe(function (value) {
    ...
    WorklistService.prototype.onShowAllCheckedStudy = function () {
        ...
        if (this.isUsingLocalTestData()) {
            ...
            this.studies.forEach(function (study) {
                if (study.checked) {
                    _this.databaseService.getStudy(study.id)
                        .subscribe(function (value) { return _this.studyDetailsLoaded(_this.studies.indexOf(study), value); });
                }
            });
        }
    };
    ...
    WorklistService.prototype.studyDetailsLoaded = function (index, studyNew) {
        ...
        if (this.studies.every(function (study) { return !study.checked || (study.checked && study.detailsLoaded); })) {
            ...
            this.studies.forEach(function (value) {
